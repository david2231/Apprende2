...
//Clase Juegossilaba
public class juegosil9 extends AppCompatActivity implements View.OnClickListener  {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_juegosil9);
        //Se llama el audio
        ...
        silba=(ImageView) findViewById(R.id.siljuegobo2);
        silbas=(ImageView) findViewById(R.id.siljuegobi4);
        silbe=(ImageView) findViewById(R.id.siljuegobi5);
        err=(ImageView) findViewById(R.id.silerror9);
        //Se llaman el contenedor
        casss=(RelativeLayout) findViewById(R.id.vista9);
        //Audio Bien
        mp= MediaPlayer.create(this,R.raw.bien);
        //Audio Mal
        mp2= MediaPlayer.create(this,R.raw.mal);
        // Sonido boca
        mp3= MediaPlayer.create(this,R.raw.boca);
        // se llaman las Imagenes
        findViewById(R.id.siljuegobo).setOnClickListener(this);
        findViewById(R.id.siljuegobo2).setOnClickListener(this);
        findViewById(R.id.siljuegobi4).setOnClickListener(this);
        findViewById(R.id.siljuegobi5).setOnClickListener(this);
        //Se declara una variable local para almacenar las palabras correctas
        puntajes=(TextView) findViewById(R.id.puntajesilabasb4);
        //Se declara una variable local para almacenar las palabras incorrectas
        incorrecta=(TextView) findViewById(R.id.incorrectassilbasb4);
        ...
        Button sonidoa = (Button)findViewById(R.id.sonidosilabas9);
        ...
        // evento botón  inicio
        Button inicio= (Button) findViewById(R.id.casa_sill9);
            ...
            case R.id.siljuegobo2:
                ...
                new Handler().postDelayed(new Runnable() {
                    ...
                    public void run() {
                        ...
                        Intent intent=new Intent(juegosil9.this,juegosil10.class);
