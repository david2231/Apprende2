...
// Clase de la actividad lectura10
public class lectura10 extends AppCompatActivity  implements View.OnClickListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_lectura10);
        //Se mantiene la pantalla activa
        getWindow().addFlags(WindowManager.LayoutParams.FLAG_KEEP_SCREEN_ON);
        //Llamado del videoview
        azul=(VideoView) findViewById(R.id.rubirosado) ;
        //LLamado a la ubicadión del video en el paquete raw
        String path=("android.resource://"+getPackageName()+"/"+R.raw.rubis);
        //Obtención del video
        ...
        findViewById(R.id.rubirosado).setOnClickListener(this);
        //Permite presionar en cualquier lugar del video para volver a reproducirlo
        bien=(TextView) findViewById(R.id.textoo10);
        //Permite presionar en cualquier lugar del video para volver a reproducirlo
        grabar = (TextView) findViewById(R.id.txtGrabarVoz10);
        //Se declara una variable local para almacenar las palabras correctas
        puntajes=(TextView) findViewById(R.id.puntajeLectura10);
        //Se declara una variable local para almacenar las palabras incorrectas
        incorrecta=(TextView) findViewById(R.id.incorrectasLectura10);
        ...
        Button inicio= (Button) findViewById(R.id.casa_lectura10);
        ...
        Button anterior= (Button) findViewById(R.id.anterior_lectura10);
        ...
        Button azull= (Button) findViewById(R.id.botonazul10);
        ...
        Button omitirr= (Button) findViewById(R.id.omitir10);
                ...
                mp.start();
                    ...
                    new Handler().postDelayed(new Runnable() {
                        ...
                        public void run() {
                                ...
                                Intent intent2=new Intent(lectura10.this, ResultadoJuegoLectura.class);
    ...
    public void onClickImgBtnHablar10(View v) {
