...
public class ResultadoJuegoSilabasg extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_resultado_juego_silabasg);
        //Se mantiene la pantalla activa
        getWindow().addFlags(WindowManager.LayoutParams.FLAG_KEEP_SCREEN_ON);
        //Llamado a la texto resultado
        txtResultados =findViewById(R.id.txtResultadosSilabag);
        //Llamado al campo variables correctas
        txtCorrectas =findViewById(R.id.txtResPalabrasCorrectasJuegoSilabag);
        //Llamado al campo variables incorrectas
        txtIncorrectas=findViewById(R.id.txtPalabrasIncorrectasSilabag);
        //Llamado al texto Incorrectas
        txtResCorrectas =findViewById(R.id.txtResPalabrasCorrectasSilabag);
        //Llamado al campo variables incorrectas
        txtResIncorrectas=findViewById(R.id.txtResPalabrasIncorrectasSilabag);
        //Permite almacenar el id del avatar
        txtPuntaje =findViewById(R.id.txtPuntajeTituloSilabag);
        //Permite almacenar el nombre del usuario
        textNickName=findViewById(R.id.textNickNameSilabag);
        //llama la Imagen del usuario
        imagenAvatar=findViewById(R.id.avatarImageSilabag);
        ...
        txtIdentificadorJuego=(TextView) findViewById(R.id.IdentificadorJuegosg);
        ...
        btnInicio=findViewById(R.id.inicioJuegoSilabag);
    ...
    private void ejecutarServcios(String URL){
        StringRequest stringRequest=new StringRequest(Request.Method.POST, URL, new Response.Listener<String>() {
            ...
            public void onErrorResponse(VolleyError error) {
                ...
                Toast.makeText(ResultadoJuegoSilabasg.this,error.toString(),Toast.LENGTH_SHORT).show();
            }
        }){
