...
public class juegosil51 extends AppCompatActivity implements View.OnClickListener  {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_juegosil51);
        mp4= MediaPlayer.create(this,R.raw.seleccionasa);
        mp4.start();
        getWindow().addFlags(WindowManager.LayoutParams.FLAG_KEEP_SCREEN_ON);
        silba=(ImageView) findViewById(R.id.siljuegosa2);
        silbas=(ImageView) findViewById(R.id.siljuegose);
        silbe=(ImageView) findViewById(R.id.siljuegosi);
        err=(ImageView) findViewById(R.id.silerror51);
        casss=(RelativeLayout) findViewById(R.id.vista51);
        mp= MediaPlayer.create(this,R.raw.bien);
        mp2= MediaPlayer.create(this,R.raw.mal);
        mp3= MediaPlayer.create(this,R.raw.saco);

        findViewById(R.id.siljuegosa2).setOnClickListener(this);
        findViewById(R.id.siljuegosi).setOnClickListener(this);
        findViewById(R.id.siljuegose).setOnClickListener(this);
        findViewById(R.id.siljuegosa).setOnClickListener(this);
        //Se declara una variable local para almacenar las palabras correctas
        puntajes=(TextView) findViewById(R.id.puntajesilabass1);
        //Se declara una variable local para almacenar las palabras incorrectas
        incorrecta=(TextView) findViewById(R.id.incorrectassilbass1);
        ...
        txtIdentificador=(TextView) findViewById(R.id.Categoria_S);
        //Declaración del identificador del submodulo
        txtIdentificadorSubmodulo=(TextView) findViewById(R.id.SubmoduloS);
        //Declaración del identificador del usuario
        textId=(TextView)findViewById(R.id.Id_user_silabaS);
        //Declaración del modulo
        Modulo=(TextView)findViewById(R.id.Modulo_LecturaS);
        //Se llama el metodo ejecutar servicios
        ejecutarServicios("https://appprende02.000webhostapp.com/Administradora.php");

        Button sonidoa = (Button)findViewById(R.id.sonidosilabas51);
        ...
        Button inicio= (Button) findViewById(R.id.casa_sill51);
            ...
            case R.id.siljuegosa2:
                ...
                new Handler().postDelayed(new Runnable() {
                    ...
                    public void run() {
                        ...
                        Intent intent=new Intent(juegosil51.this,juegosil52.class);
    ...
    private void ejecutarServicios(String URL){
        StringRequest stringRequest=new StringRequest(Request.Method.POST, URL, new Response.Listener<String>() {
            ...
            public void onErrorResponse(VolleyError error) {
                Toast.makeText(juegosil51.this,error.toString(),Toast.LENGTH_SHORT).show();
