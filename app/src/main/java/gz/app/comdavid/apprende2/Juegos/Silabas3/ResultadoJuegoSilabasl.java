...
public class ResultadoJuegoSilabasl extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_resultado_juego_silabasl);
        //Se mantiene la pantalla activa
        getWindow().addFlags(WindowManager.LayoutParams.FLAG_KEEP_SCREEN_ON);
        //Llamado a la texto resultado
        txtResultados =findViewById(R.id.txtResultadosSilabal);
        //Llamado al campo variables correctas
        txtCorrectas =findViewById(R.id.txtResPalabrasCorrectasJuegoSilabal);
        //Llamado al campo variables incorrectas
        txtIncorrectas=findViewById(R.id.txtPalabrasIncorrectasSilabal);
        //Llamado al texto Incorrectas
        txtResCorrectas =findViewById(R.id.txtResPalabrasCorrectasSilabal);
        //Llamado al campo variables incorrectas
        txtResIncorrectas=findViewById(R.id.txtResPalabrasIncorrectasSilabal);
        //Permite almacenar el id del avatar
        txtPuntaje =findViewById(R.id.txtPuntajeTituloSilabal);
        //Permite almacenar el nombre del usuario
        textNickName=findViewById(R.id.textNickNameSilabal);
        //llama la Imagen del usuario
        imagenAvatar=findViewById(R.id.avatarImageSilabal);
        ...
        txtIdentificadorJuego=(TextView) findViewById(R.id.IdentificadorJuegosl);
        ...
        btnInicio=findViewById(R.id.inicioJuegoSilabal);
    ...
    private void ejecutarServcios(String URL){
        StringRequest stringRequest=new StringRequest(Request.Method.POST, URL, new Response.Listener<String>() {
            ...
            public void onErrorResponse(VolleyError error) {
                ...
                Toast.makeText(ResultadoJuegoSilabasl.this,error.toString(),Toast.LENGTH_SHORT).show();
            }
        }){
