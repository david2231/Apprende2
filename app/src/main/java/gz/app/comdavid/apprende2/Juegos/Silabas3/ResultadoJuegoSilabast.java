...
public class ResultadoJuegoSilabast extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_resultado_juego_silabast);
        //Se mantiene la pantalla activa
        getWindow().addFlags(WindowManager.LayoutParams.FLAG_KEEP_SCREEN_ON);
        //Llamado a la texto resultado
        txtResultados =findViewById(R.id.txtResultadosSilabat);
        //Llamado al campo variables correctas
        txtCorrectas =findViewById(R.id.txtResPalabrasCorrectasJuegoSilabat);
        //Llamado al campo variables incorrectas
        txtIncorrectas=findViewById(R.id.txtPalabrasIncorrectasSilabat);
        //Llamado al texto Incorrectas
        txtResCorrectas =findViewById(R.id.txtResPalabrasCorrectasSilabat);
        //Llamado al campo variables incorrectas
        txtResIncorrectas=findViewById(R.id.txtResPalabrasIncorrectasSilabat);
        ...
        textNickName=findViewById(R.id.textNickNameSilabat);
        //llama la Imagen del usuario
        imagenAvatar=findViewById(R.id.avatarImageSilabat);
        ...
        txtIdentificadorJuego=(TextView) findViewById(R.id.IdentificadorJuegost);
        ...
        btnInicio=findViewById(R.id.inicioJuegoSilabat);
    ...
    private void ejecutarServcios(String URL){
        StringRequest stringRequest=new StringRequest(Request.Method.POST, URL, new Response.Listener<String>() {
            ...
            public void onErrorResponse(VolleyError error) {
                Toast.makeText(ResultadoJuegoSilabast.this,error.toString(),Toast.LENGTH_SHORT).show();
            }
        }){
