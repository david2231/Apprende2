...
public class Drawable_letter_qq extends AppCompatActivity implements Main_drawable.DrawFinishListener {
    MediaPlayer mp,mp2;
    Button button;
            ...
            public void onClick(View v) {
                ...
                new Handler().postDelayed(new Runnable() {
                    ...
                    public void run() {
                        ...
                        Intent intent=new Intent(Drawable_letter_qq.this, Drawable_letter_qq.class);
