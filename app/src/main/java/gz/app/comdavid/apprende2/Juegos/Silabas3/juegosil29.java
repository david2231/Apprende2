...
//Clase Juegossilaba
public class juegosil29 extends AppCompatActivity implements View.OnClickListener  {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_juegosil29);
        //Se llama el audio
        ...
        silba=(ImageView) findViewById(R.id.siljuegolo2);
        silbas=(ImageView) findViewById(R.id.siljuegoli4);
        silbe=(ImageView) findViewById(R.id.siljuegoli5);
        err=(ImageView) findViewById(R.id.silerror29);
        //Se llaman el contenedor
        casss=(RelativeLayout) findViewById(R.id.vista29);
        //Audio Bien
        mp= MediaPlayer.create(this,R.raw.bien);
        //Audio Mal
        mp2= MediaPlayer.create(this,R.raw.mal);
        // Sonido loro
        mp3= MediaPlayer.create(this,R.raw.loro);
        // se llaman las Imagenes
        findViewById(R.id.siljuegolo).setOnClickListener(this);
        findViewById(R.id.siljuegolo2).setOnClickListener(this);
        findViewById(R.id.siljuegoli4).setOnClickListener(this);
        findViewById(R.id.siljuegoli5).setOnClickListener(this);

        //Se declara una variable local para almacenar las palabras correctas
        puntajes=(TextView) findViewById(R.id.puntajesilabasl4);
        //Se declara una variable local para almacenar las palabras incorrectas
        incorrecta=(TextView) findViewById(R.id.incorrectassilbasl4);
        //Se actualizan los campos de correctas  e incorrectas con las variables globales de utilidades
        puntajes.setText(Integer.toString(Utilidades.correctas));
        incorrecta.setText(Integer.toString(Utilidades.incorrectas));

        // sonido de la silaba 29
        Button sonidoa = (Button)findViewById(R.id.sonidosilabas29);
        ...
        // evento botón  inicio
        Button inicio= (Button) findViewById(R.id.casa_sill29);
            ...
            case R.id.siljuegolo2:
                ...
                new Handler().postDelayed(new Runnable() {
                    ...
                    public void run() {
                        ...
                        Intent intent=new Intent(juegosil29.this,juegosil30.class);
