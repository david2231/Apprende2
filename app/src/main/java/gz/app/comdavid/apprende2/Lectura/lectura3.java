...
// Clase de la actividad lectura3
public class lectura3 extends AppCompatActivity  implements View.OnClickListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        azul=(VideoView) findViewById(R.id.abjeasmiel) ;
        //LLamado a la ubicadión del video en el paquete raw
        String path=("android.resource://"+getPackageName()+"/"+R.raw.abeja);
        //Obtención del video
        ...
        findViewById(R.id.abjeasmiel).setOnClickListener(this);
        //Salida de texto en pantalla
        bien=(TextView) findViewById(R.id.textoo3);
        //Permite presionar en cualquier lugar del video para volver a reproducirlo
        grabar = (TextView) findViewById(R.id.txtGrabarVoz3);
        //Se declara una variable local para almacenar las palabras correctas
        puntajes=(TextView) findViewById(R.id.puntajeLectura3);
        //Se declara una variable local para almacenar las palabras incorrectas
        incorrecta=(TextView) findViewById(R.id.incorrectasLectura3);
        ...
        Button inicio= (Button) findViewById(R.id.casa_lectura3);
        ...
        Button sig= (Button) findViewById(R.id.siguiente_lectura3);
        ...
        Button anterior= (Button) findViewById(R.id.anterior_lectura3);
        //Abrir una nueva actividad
        ...
        Button azull= (Button) findViewById(R.id.botonazul3);
        ...
        Button omitirr= (Button) findViewById(R.id.omitir3);
    ...
    public void onClickImgBtnHablar3(View v) {
