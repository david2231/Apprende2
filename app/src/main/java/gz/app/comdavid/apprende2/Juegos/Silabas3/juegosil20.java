...
//Clase Juegossilaba
public class juegosil20 extends AppCompatActivity implements View.OnClickListener  {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_juegosil20);
        //Se llama el audio
        ...
        silba=(ImageView) findViewById(R.id.siljuegofu5);
        silbas=(ImageView) findViewById(R.id.siljuegofo4);
        silbe=(ImageView) findViewById(R.id.siljuegofa4);
        err=(ImageView) findViewById(R.id.silerror20);
        //Se llaman el contenedor
        casss=(RelativeLayout) findViewById(R.id.vista20);
        //Audio Bien
        mp= MediaPlayer.create(this,R.raw.bien);
        //Audio Mal
        mp2= MediaPlayer.create(this,R.raw.mal);
        // Sonido fuego
        mp3= MediaPlayer.create(this,R.raw.fuego);
        // se llaman las Imagenes
        findViewById(R.id.siljuegofu1).setOnClickListener(this);
        findViewById(R.id.siljuegofu5).setOnClickListener(this);
        findViewById(R.id.siljuegofo4).setOnClickListener(this);
        findViewById(R.id.siljuegofa4).setOnClickListener(this);
        //Se declara una variable local para almacenar las palabras correctas
        puntajes=(TextView) findViewById(R.id.puntajesilabasf5);
        //Se declara una variable local para almacenar las palabras incorrectas
        incorrecta=(TextView) findViewById(R.id.incorrectassilbasf5);
        //Se actualizan los campos de correctas  e incorrectas con las variables globales de utilidades
        puntajes.setText(Integer.toString(Utilidades.correctas));
        incorrecta.setText(Integer.toString(Utilidades.incorrectas));

        // sonido de la silaba 20
        Button sonidoa = (Button)findViewById(R.id.sonidosilabas20);
        ...
        // evento botón  inicio
        Button inicio= (Button) findViewById(R.id.casa_sill20);
            ...
            case R.id.siljuegofu5:
                ...
                new Handler().postDelayed(new Runnable() {
                    ...
                    public void run() {
                        ...
                        Intent intent=new Intent(juegosil20.this, ResultadoJuegoSilabasf.class);
