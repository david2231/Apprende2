...
public class Drawable_letter_mm extends AppCompatActivity implements Main_drawable.DrawFinishListener {
    MediaPlayer mp,mp2;
    Button button;
    ...
    protected void onCreate(Bundle savedInstanceState) {
            ...
            public void onClick(View v) {
                ...
                new Handler().postDelayed(new Runnable() {
                    ...
                    public void run() {
                        ...
                        Intent intent=new Intent(Drawable_letter_mm.this, Drawable_letter_mm.class);
        ...
        int drawable = R.drawable.letramm;
    ...
    public void onDrawFinish() {
        ...
        new Handler().postDelayed(new Runnable() {
            ...
            public void run() {
                ...
                Intent intent=new Intent(Drawable_letter_mm.this, Drawable_letter_nn.class);
                startActivity(intent);
