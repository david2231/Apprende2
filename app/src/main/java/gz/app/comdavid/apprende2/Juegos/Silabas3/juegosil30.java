...
//Clase Juegossilaba
public class juegosil30 extends AppCompatActivity implements View.OnClickListener  {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_juegosil30);
        //Se llama el audio
        ...
        silba=(ImageView) findViewById(R.id.siljuegolu5);
        silbas=(ImageView) findViewById(R.id.siljuegolo4);
        silbe=(ImageView) findViewById(R.id.siljuegola4);
        err=(ImageView) findViewById(R.id.silerror30);
        //Se llaman el contenedor
        casss=(RelativeLayout) findViewById(R.id.vista30);
        //Audio Bien
        mp= MediaPlayer.create(this,R.raw.bien);
        //Audio Mal
        mp2= MediaPlayer.create(this,R.raw.mal);
        // Sonido luna
        mp3= MediaPlayer.create(this,R.raw.luna);
        // se llaman las Imagenes
        findViewById(R.id.siljuegolu1).setOnClickListener(this);
        findViewById(R.id.siljuegolu5).setOnClickListener(this);
        findViewById(R.id.siljuegolo4).setOnClickListener(this);
        findViewById(R.id.siljuegola4).setOnClickListener(this);
        //Se declara una variable local para almacenar las palabras correctas
        puntajes=(TextView) findViewById(R.id.puntajesilabasl5);
        //Se declara una variable local para almacenar las palabras incorrectas
        incorrecta=(TextView) findViewById(R.id.incorrectassilbasl5);

        //Se actualizan los campos de correctas  e incorrectas con las variables globales de utilidades
        puntajes.setText(Integer.toString(Utilidades.correctas));
        incorrecta.setText(Integer.toString(Utilidades.incorrectas));

        // sonido de la silaba 30
        Button sonidoa = (Button)findViewById(R.id.sonidosilabas30);
        ...
        // evento botón  inicio
        Button inicio= (Button) findViewById(R.id.casa_sill30);
            ...
            case R.id.siljuegolu5:
                ...
                new Handler().postDelayed(new Runnable() {
                    ...
                    public void run() {
                        ...
                        Intent intent=new Intent(juegosil30.this, ResultadoJuegoSilabasl.class);
