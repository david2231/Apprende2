...
public class juegosil36 extends AppCompatActivity implements View.OnClickListener  {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        puntajes=(TextView) findViewById(R.id.puntajesilabasn1);
        //Se declara una variable local para almacenar las palabras incorrectas
        incorrecta=(TextView) findViewById(R.id.incorrectassilbasn1);
        ...
        txtIdentificador=(TextView) findViewById(R.id.Categoria_N);
        //Declaración del identificador del submodulo
        txtIdentificadorSubmodulo=(TextView) findViewById(R.id.SubmoduloN);
        //Declaración del identificador del usuario
        textNickName=(TextView)findViewById(R.id.Nombre_user_JuegoN);
        //Declaración del modulo
        Modulo=(TextView)findViewById(R.id.Modulo_LecturaN);
    ...
    private void ejecutarServicios(String URL){
        StringRequest stringRequest=new StringRequest(Request.Method.POST, URL, new Response.Listener<String>() {
            ...
            public void onErrorResponse(VolleyError error) {
                Toast.makeText(juegosil36.this,error.toString(),Toast.LENGTH_SHORT).show();
