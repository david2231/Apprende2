...
public class juegosil56 extends AppCompatActivity implements View.OnClickListener  {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        puntajes=(TextView) findViewById(R.id.puntajesilabast1);
        //Se declara una variable local para almacenar las palabras incorrectas
        incorrecta=(TextView) findViewById(R.id.incorrectassilbast1);
        ...
        txtIdentificador=(TextView) findViewById(R.id.Categoria_T);
        //Declaración del identificador del submodulo
        txtIdentificadorSubmodulo=(TextView) findViewById(R.id.SubmoduloT);
        //Declaración del identificador del usuario
        textNickName=(TextView)findViewById(R.id.Nombre_user_JuegoT);
        //Declaración del modulo
        Modulo=(TextView)findViewById(R.id.Modulo_LecturaT);
    ...
    private void ejecutarServicios(String URL){
        StringRequest stringRequest=new StringRequest(Request.Method.POST, URL, new Response.Listener<String>() {
            ...
            public void onErrorResponse(VolleyError error) {
                Toast.makeText(juegosil56.this,error.toString(),Toast.LENGTH_SHORT).show();
