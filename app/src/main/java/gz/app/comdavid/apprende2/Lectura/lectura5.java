...
// Clase de la actividad lectura5
public class lectura5 extends AppCompatActivity  implements View.OnClickListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        azul=(VideoView) findViewById(R.id.camisaboton) ;
        //LLamado a la ubicadión del video en el paquete raw
        String path=("android.resource://"+getPackageName()+"/"+R.raw.camisa);
        //Obtención del video
        ...
        findViewById(R.id.camisaboton).setOnClickListener(this);
        //Salida de texto en pantalla
        bien=(TextView) findViewById(R.id.textoo5);
        //Permite presionar en cualquier lugar del video para volver a reproducirlo
        grabar = (TextView) findViewById(R.id.txtGrabarVoz5);
        //Se declara una variable local para almacenar las palabras correctas
        puntajes=(TextView) findViewById(R.id.puntajeLectura5);
        //Se declara una variable local para almacenar las palabras incorrectas
        incorrecta=(TextView) findViewById(R.id.incorrectasLectura5);
        ...
        Button inicio= (Button) findViewById(R.id.casa_lectura5);
        ...
        Button sig= (Button) findViewById(R.id.siguiente_lectura5);
        sig.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                //Abrir una nueva actividad
                Intent intent=new Intent(v.getContext(),lectura6.class);
                startActivityForResult(intent,0);
                //Transiciones
        ...
        Button anterior= (Button) findViewById(R.id.anterior_lectura5);
        anterior.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent=new Intent(v.getContext(),lectura4.class);
                startActivityForResult(intent,0);
                overridePendingTransition(R.anim.right_in, R.anim.right_out);
                azul.stopPlayback();
                azul.seekTo(0);
        ...
        Button azull= (Button) findViewById(R.id.botonazul5);
        ...
        Button omitirr= (Button) findViewById(R.id.omitir5);
    ...
    public void onClickImgBtnHablar5(View v) {
