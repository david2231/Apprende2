...
//Clase Juegossilaba
public class juegosil24 extends AppCompatActivity implements View.OnClickListener  {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_juegosil24);
        //Se llama el audio
        ...
        silba=(ImageView) findViewById(R.id.siljuegogo2);
        silbas=(ImageView) findViewById(R.id.siljuegogi4);
        silbe=(ImageView) findViewById(R.id.siljuegogi5);
        err=(ImageView) findViewById(R.id.silerror24);
        //Se llaman el contenedor
        casss=(RelativeLayout) findViewById(R.id.vista24);
        //Audio Bien
        ...
        findViewById(R.id.siljuegogo1).setOnClickListener(this);
        findViewById(R.id.siljuegogo2).setOnClickListener(this);
        findViewById(R.id.siljuegogi4).setOnClickListener(this);
        findViewById(R.id.siljuegogi5).setOnClickListener(this);
        //Se declara una variable local para almacenar las palabras correctas
        puntajes=(TextView) findViewById(R.id.puntajesilabasg4);
        //Se declara una variable local para almacenar las palabras incorrectas
        incorrecta=(TextView) findViewById(R.id.incorrectassilbasg4);
        ...
        Button sonidoa = (Button)findViewById(R.id.sonidosilabas24);
        ...
        // evento botón  inicio
        Button inicio= (Button) findViewById(R.id.casa_sill24);
            ...
            case R.id.siljuegogo2:
                ...
                new Handler().postDelayed(new Runnable() {
                    ...
                    public void run() {
                        ...
                        Intent intent=new Intent(juegosil24.this,juegosil25.class);
