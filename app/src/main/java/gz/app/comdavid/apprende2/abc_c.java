...
public class abc_c extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_abc_c);
        //Llamar el boton
        ...
        //Llamar el boton
        Button next= (Button) findViewById(R.id.siguiente_c);
        //Metodo OnClick
        ...
        //Llamar el boton
        Button back= (Button) findViewById(R.id.anterioir_c);
        ...
        mp= MediaPlayer.create(this,R.raw.sonidoc);
