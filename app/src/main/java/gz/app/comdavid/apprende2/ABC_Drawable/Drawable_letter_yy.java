...
public class Drawable_letter_yy extends AppCompatActivity implements Main_drawable.DrawFinishListener {
    MediaPlayer mp,mp2;
    Button button;
    ...
    protected void onCreate(Bundle savedInstanceState) {
            ...
            public void onClick(View v) {
                ...
                new Handler().postDelayed(new Runnable() {
                    ...
                    public void run() {
                        ...
                        Intent intent=new Intent(Drawable_letter_yy.this, Drawable_letter_yy.class);
        ...
        int drawable = R.drawable.letrayy;
    ...
    public void onDrawFinish() {
        ...
        new Handler().postDelayed(new Runnable() {
            ...
            public void run() {
                ...
                Intent intent=new Intent(Drawable_letter_yy.this, Drawable_letter_zz.class);
                startActivity(intent);
