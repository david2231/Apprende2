...
public class ResultadoJuegoSilabass extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_resultado_juego_silabass);
        //Se mantiene la pantalla activa
        getWindow().addFlags(WindowManager.LayoutParams.FLAG_KEEP_SCREEN_ON);
        //Llamado a la texto resultado
        txtResultados =findViewById(R.id.txtResultadosSilabas);
        //Llamado al campo variables correctas
        txtCorrectas =findViewById(R.id.txtResPalabrasCorrectasJuegoSilabas);
        //Llamado al campo variables incorrectas
        txtIncorrectas=findViewById(R.id.txtPalabrasIncorrectasSilabas);
        //Llamado al texto Incorrectas
        txtResCorrectas =findViewById(R.id.txtResPalabrasCorrectasSilabas);
        //Llamado al campo variables incorrectas
        txtResIncorrectas=findViewById(R.id.txtResPalabrasIncorrectasSilabas);
        //Permite almacenar el id del avatar
        txtPuntaje =findViewById(R.id.txtPuntajeTituloSilabas);
        //Permite almacenar el nombre del usuario
        textNickName=findViewById(R.id.textNickNameSilabas);
        //llama la Imagen del usuario
        imagenAvatar=findViewById(R.id.avatarImageSilabas);
        ...
        txtIdentificadorJuego=(TextView) findViewById(R.id.IdentificadorJuegoss);
        ...
        btnInicio=findViewById(R.id.inicioJuegoSilabas);
    ...
    private void ejecutarServcios(String URL){
        StringRequest stringRequest=new StringRequest(Request.Method.POST, URL, new Response.Listener<String>() {
            ...
            public void onErrorResponse(VolleyError error) {
                Toast.makeText(ResultadoJuegoSilabass.this,error.toString(),Toast.LENGTH_SHORT).show();
            }
        }){
