...
public class ResultadoJuegoSilabasp extends AppCompatActivity {
    // Se realiza la declaración de los textview
    TextView txtResCorrectas,txtResIncorrectas,txtCorrectas,txtIncorrectas,txtResultados,txtPuntaje,textNickName,txtIdentificadorJuego;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_resultado_juego_silabasp);
        //Se mantiene la pantalla activa
        getWindow().addFlags(WindowManager.LayoutParams.FLAG_KEEP_SCREEN_ON);
        //Llamado a la texto resultado
        txtResultados =findViewById(R.id.txtResultadosSilabap);
        //Llamado al campo variables correcta
        txtCorrectas =findViewById(R.id.txtResPalabrasCorrectasJuegoSilabap);
        //Llamado al campo variables incorrectas
        txtIncorrectas=findViewById(R.id.txtPalabrasIncorrectasSilabap);
        //Llamado al texto Incorrectas
        txtResCorrectas =findViewById(R.id.txtResPalabrasCorrectasSilabap);
        //Llamado al campo variables incorrectas
        txtResIncorrectas=findViewById(R.id.txtResPalabrasIncorrectasSilabap);
        //Permite almacenar el id del avatar
        txtPuntaje =findViewById(R.id.txtPuntajeTituloSilabap);
        //Permite almacenar el nombre del usuario
        textNickName=findViewById(R.id.textNickNameSilabap);
        //llama la Imagen del usuario
        imagenAvatar=findViewById(R.id.avatarImageSilabap);
        ...
        txtIdentificadorJuego=(TextView) findViewById(R.id.IdentificadorJuegosp);
        ...
        btnInicio=findViewById(R.id.inicioJuegoSilabap);
    ...
    private void ejecutarServcios(String URL){
        StringRequest stringRequest=new StringRequest(Request.Method.POST, URL, new Response.Listener<String>() {
            ...
            public void onErrorResponse(VolleyError error) {
                Toast.makeText(ResultadoJuegoSilabasp.this,error.toString(),Toast.LENGTH_SHORT).show();
            }
        }){
            ...
            protected Map<String, String> getParams() throws AuthFailureError {
                ...
                parametros.put("Id_Juego",txtIdentificadorJuego.getText().toString());
