...
// Clase de la actividad lectura8
public class lectura8 extends AppCompatActivity  implements View.OnClickListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_lectura8);
        //Se mantiene la pantalla activa
        getWindow().addFlags(WindowManager.LayoutParams.FLAG_KEEP_SCREEN_ON);
        //Llamado del videoview
        azul=(VideoView) findViewById(R.id.platanomaduro) ;
        //LLamado a la ubicadión del video en el paquete raw
        String path=("android.resource://"+getPackageName()+"/"+R.raw.platano);
        //Obtención del video
        ...
        findViewById(R.id.platanomaduro).setOnClickListener(this);
        //Permite presionar en cualquier lugar del video para volver a reproducirlo
        bien=(TextView) findViewById(R.id.textoo8);
        //Permite presionar en cualquier lugar del video para volver a reproducirlo
        grabar = (TextView) findViewById(R.id.txtGrabarVoz8);
        //Se declara una variable local para almacenar las palabras correctas
        puntajes=(TextView) findViewById(R.id.puntajeLectura8);
        //Se declara una variable local para almacenar las palabras incorrectas
        incorrecta=(TextView) findViewById(R.id.incorrectasLectura8);
        ...
        Button inicio= (Button) findViewById(R.id.casa_lectura8);
        ...
        Button sig= (Button) findViewById(R.id.siguiente_lectura8);
        sig.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {

                //Abrir una nueva actividad
                Intent intent=new Intent(v.getContext(),lectura9.class);
                startActivityForResult(intent,0);
                //Transiciones
        ...
        Button anterior= (Button) findViewById(R.id.anterior_lectura8);
        anterior.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent=new Intent(v.getContext(),lectura7.class);
                startActivityForResult(intent,0);
                overridePendingTransition(R.anim.right_in, R.anim.right_out);
                azul.stopPlayback();
                azul.seekTo(0);
        ...
        Button azull= (Button) findViewById(R.id.botonazul8);
        ...
        Button omitirr= (Button) findViewById(R.id.omitir8);
    ...
    public void onClickImgBtnHablar8(View v) {
