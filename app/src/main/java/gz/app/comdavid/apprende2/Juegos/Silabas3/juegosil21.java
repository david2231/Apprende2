...
//Clase Juegossilaba
public class juegosil21 extends AppCompatActivity implements View.OnClickListener  {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_juegosil21);
        //Se llama el audio
        mp4= MediaPlayer.create(this,R.raw.seleccionaga);
        //Reproduce el audio
        mp4.start();
        //Mantiene la pantalla activa
        getWindow().addFlags(WindowManager.LayoutParams.FLAG_KEEP_SCREEN_ON);
        //Se llaman las 5 silabas de la vista
        silba=(ImageView) findViewById(R.id.siljuegoga2);
        silbas=(ImageView) findViewById(R.id.siljuegoge);
        silbe=(ImageView) findViewById(R.id.siljuegogi);
        err=(ImageView) findViewById(R.id.silerror21);
        //Se llaman el contenedor
        casss=(RelativeLayout) findViewById(R.id.vista21);
        //Audio Bien
        mp= MediaPlayer.create(this,R.raw.bien);
        //Audio Mal
        mp2= MediaPlayer.create(this,R.raw.mal);
        // Sonido gato
        mp3= MediaPlayer.create(this,R.raw.gato);

        // se llaman las Imagenes
        findViewById(R.id.siljuegoga2).setOnClickListener(this);
        findViewById(R.id.siljuegogi).setOnClickListener(this);
        findViewById(R.id.siljuegoge).setOnClickListener(this);
        findViewById(R.id.siljuegoga).setOnClickListener(this);
        //Se declara una variable local para almacenar las palabras correctas
        puntajes=(TextView) findViewById(R.id.puntajesilabasg1);
        //Se declara una variable local para almacenar las palabras incorrectas
        incorrecta=(TextView) findViewById(R.id.incorrectassilbasg1);
        ...
        txtIdentificador=(TextView) findViewById(R.id.Categoria_G);
        //Declaración del identificador del submodulo
        txtIdentificadorSubmodulo=(TextView) findViewById(R.id.SubmoduloG);
        //Declaración del identificador del usuario
        textNickName=(TextView)findViewById(R.id.Nombre_user_JuegoG);
        //Declaración del modulo
        Modulo=(TextView)findViewById(R.id.Modulo_LecturaG);
        //Se llama el metodo ejecutar servicios
        ejecutarServicios("https://appprende02.000webhostapp.com/Administradora.php");

        // sonido de la silaba 21
        Button sonidoa = (Button)findViewById(R.id.sonidosilabas21);
        ...
        // evento botón  inicio
        Button inicio= (Button) findViewById(R.id.casa_sill21);
            ...
            case R.id.siljuegoge:
                ...
                new Handler().postDelayed(new Runnable() {
                    ...
                    public void run() {
                        ...
                        Intent intent=new Intent(juegosil21.this,juegosil22.class);
    ...
    private void ejecutarServicios(String URL){
        StringRequest stringRequest=new StringRequest(Request.Method.POST, URL, new Response.Listener<String>() {
            ...
            public void onErrorResponse(VolleyError error) {
                Toast.makeText(juegosil21.this,error.toString(),Toast.LENGTH_SHORT).show();
