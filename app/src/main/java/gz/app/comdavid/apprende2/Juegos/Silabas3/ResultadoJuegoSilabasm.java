...
public class ResultadoJuegoSilabasm extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_resultado_juego_silabasm);
        //Se mantiene la pantalla activa
        getWindow().addFlags(WindowManager.LayoutParams.FLAG_KEEP_SCREEN_ON);
        //Llamado a la texto resultado
        txtResultados =findViewById(R.id.txtResultadosSilabam);
        //Llamado al campo variables correctas
        txtCorrectas =findViewById(R.id.txtResPalabrasCorrectasJuegoSilabam);
        //Llamado al campo variables incorrectas
        txtIncorrectas=findViewById(R.id.txtPalabrasIncorrectasSilabam);
        //Llamado al texto Incorrectas
        txtResCorrectas =findViewById(R.id.txtResPalabrasCorrectasSilabam);
        //Llamado al campo variables incorrectas
        txtResIncorrectas=findViewById(R.id.txtResPalabrasIncorrectasSilabam);
        //Permite almacenar el id del avatar
        txtPuntaje =findViewById(R.id.txtPuntajeTituloSilabam);
        //Permite almacenar el nombre del usuario
        textNickName=findViewById(R.id.textNickNameSilabam);
        //llama la Imagen del usuario
        imagenAvatar=findViewById(R.id.avatarImageSilabam);
        ...
        txtIdentificadorJuego=(TextView) findViewById(R.id.IdentificadorJuegosm);
        ...
        btnInicio=findViewById(R.id.inicioJuegoSilabam);
    ...
    private void ejecutarServcios(String URL){
        StringRequest stringRequest=new StringRequest(Request.Method.POST, URL, new Response.Listener<String>() {
            ...
            public void onErrorResponse(VolleyError error) {
                Toast.makeText(ResultadoJuegoSilabasm.this,error.toString(),Toast.LENGTH_SHORT).show();
