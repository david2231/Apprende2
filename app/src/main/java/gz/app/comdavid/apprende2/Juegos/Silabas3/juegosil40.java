...
//Clase Juegossilaba
public class juegosil40 extends AppCompatActivity implements View.OnClickListener  {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_juegosil40);
        //Se llama el audio
        ...
        silba=(ImageView) findViewById(R.id.siljuegonu5);
        silbas=(ImageView) findViewById(R.id.siljuegono4);
        silbe=(ImageView) findViewById(R.id.siljuegona4);
        err=(ImageView) findViewById(R.id.silerror40);
        //Se llaman el contenedor
        casss=(RelativeLayout) findViewById(R.id.vista40);
        //Audio Bien
        mp= MediaPlayer.create(this,R.raw.bien);
        //Audio Mal
        mp2= MediaPlayer.create(this,R.raw.mal);
        // Sonido Casa
        mp3= MediaPlayer.create(this,R.raw.nube);
        // se llaman las Imagenes
        findViewById(R.id.siljuegonu1).setOnClickListener(this);
        findViewById(R.id.siljuegonu5).setOnClickListener(this);
        findViewById(R.id.siljuegono4).setOnClickListener(this);
        findViewById(R.id.siljuegona4).setOnClickListener(this);

        //Se declara una variable local para almacenar las palabras correctas
        puntajes=(TextView) findViewById(R.id.puntajesilabasn5);
        //Se declara una variable local para almacenar las palabras incorrectas
        incorrecta=(TextView) findViewById(R.id.incorrectassilbasn5);
        //Se actualizan los campos de correctas  e incorrectas con las variables globales de utilidades
        puntajes.setText(Integer.toString(Utilidades.correctas));
        incorrecta.setText(Integer.toString(Utilidades.incorrectas));

        // sonido de la silaba 40
        Button sonidoa = (Button)findViewById(R.id.sonidosilabas40);
        ...
        // evento botón  inicio
        Button inicio= (Button) findViewById(R.id.casa_sill40);
            ...
            case R.id.siljuegonu5:
                ...
                new Handler().postDelayed(new Runnable() {
                    ...
                    public void run() {
                        ...
                        Intent intent=new Intent(juegosil40.this, ResultadoJuegoSilabasn.class);
