...
public class ResultadoJuegoSilabasn extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_resultado_juego_silabasn);
        //Se mantiene la pantalla activa
        getWindow().addFlags(WindowManager.LayoutParams.FLAG_KEEP_SCREEN_ON);
        //Llamado a la texto resultado
        txtResultados =findViewById(R.id.txtResultadosSilaban);
        //Llamado al campo variables correctas
        txtCorrectas =findViewById(R.id.txtResPalabrasCorrectasJuegoSilaban);
        //Llamado al campo variables incorrectas
        txtIncorrectas=findViewById(R.id.txtPalabrasIncorrectasSilaban);
        //Llamado al texto Incorrectas
        txtResCorrectas =findViewById(R.id.txtResPalabrasCorrectasSilaban);
        //Llamado al campo variables incorrectas
        txtResIncorrectas=findViewById(R.id.txtResPalabrasIncorrectasSilaban);
        //Permite almacenar el id del avatar
        txtPuntaje =findViewById(R.id.txtPuntajeTituloSilaban);
        //Permite almacenar el nombre del usuario
        textNickName=findViewById(R.id.textNickNameSilaban);
        //llama la Imagen del usuario
        imagenAvatar=findViewById(R.id.avatarImageSilaban);
        ...
        txtIdentificadorJuego=(TextView) findViewById(R.id.IdentificadorJuegosn);
        ...
        btnInicio=findViewById(R.id.inicioJuegoSilaban);
    ...
    private void ejecutarServcios(String URL){
        StringRequest stringRequest=new StringRequest(Request.Method.POST, URL, new Response.Listener<String>() {
            ...
            public void onErrorResponse(VolleyError error) {
                Toast.makeText(ResultadoJuegoSilabasn.this,error.toString(),Toast.LENGTH_SHORT).show();
            }
        }){
