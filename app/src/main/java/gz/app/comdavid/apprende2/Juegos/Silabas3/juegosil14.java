...
//Clase Juegossilaba
public class juegosil14 extends AppCompatActivity implements View.OnClickListener  {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_juegosil14);
        //Se llama el audio
        ...
        silba=(ImageView) findViewById(R.id.siljuegodo2);
        silbas=(ImageView) findViewById(R.id.siljuegodi4);
        silbe=(ImageView) findViewById(R.id.siljuegodi5);
        err=(ImageView) findViewById(R.id.silerror14);
        //Se llaman el contenedor
        casss=(RelativeLayout) findViewById(R.id.vista14);
        //Audio Bien
        mp= MediaPlayer.create(this,R.raw.bien);
        //Audio Mal
        mp2= MediaPlayer.create(this,R.raw.mal);
        // Sonido Casa
        mp3= MediaPlayer.create(this,R.raw.doctor);
        // se llaman las Imagenes
        findViewById(R.id.siljuegodo).setOnClickListener(this);
        findViewById(R.id.siljuegodo2).setOnClickListener(this);
        findViewById(R.id.siljuegodi4).setOnClickListener(this);
        findViewById(R.id.siljuegodi5).setOnClickListener(this);
        //Se declara una variable local para almacenar las palabras correctas
        puntajes=(TextView) findViewById(R.id.puntajesilabasd4);
        //Se declara una variable local para almacenar las palabras incorrectas
        incorrecta=(TextView) findViewById(R.id.incorrectassilbasd4);
        //Se actualizan los campos de correctas  e incorrectas con las variables globales de utilidades
        puntajes.setText(Integer.toString(Utilidades.correctas));
        incorrecta.setText(Integer.toString(Utilidades.incorrectas));


        // sonido de la silaba 14
        Button sonidoa = (Button)findViewById(R.id.sonidosilabas14);
        ...
        // evento botón  inicio
        Button inicio= (Button) findViewById(R.id.casa_sill14);
            ...
            case R.id.siljuegodo2:
                ...
                new Handler().postDelayed(new Runnable() {
                    ...
                    public void run() {
                        ...
                        Intent intent=new Intent(juegosil14.this,juegosil15.class);
