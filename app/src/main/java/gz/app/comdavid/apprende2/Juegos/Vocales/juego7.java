...
public class juego7 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_juego7);
        ...
        err=(ImageView) findViewById(R.id.errores7);
        ...
        txta33=(TextView) findViewById(R.id.txtjc7);
        //Llamado a la palabra _SPEJO
        txta44=(TextView) findViewById(R.id.target7);
        //Se declara una variable local para almacenar las palabras correctas
        puntajes=(TextView) findViewById(R.id.puntaje7);
        //Se declara una variable local para almacenar las palabras incorrectas
        incorrecta=(TextView) findViewById(R.id.incorrectas7);
        ...
        Button inicio= (Button) findViewById(R.id.casa_aa7);
        ...
        Button avatar=(Button) findViewById(R.id.sonidosilabas7);
            ...
            switch (dragEvent){
                ...
                case DragEvent.ACTION_DRAG_ENTERED:
                    ...
                    //Si se selecciona la opción número 2
                        ...
                        //si se selecciona la opción número 3
                        else if (view.getId() == R.id.txtjc7) {
                            ...
                            new Handler().postDelayed(new Runnable() {
                                ...
                                public void run() {
                                    //Abrir una nueva actividad
                                    Intent intent=new Intent(juego7.this,juego8.class);
