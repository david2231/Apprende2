...
public class Drawable_letter_tt extends AppCompatActivity implements Main_drawable.DrawFinishListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
            ...
            public void onClick(View v) {
                ...
                new Handler().postDelayed(new Runnable() {
                    ...
                    public void run() {
                        ...
                        Intent intent=new Intent(Drawable_letter_tt.this, Drawable_letter_tt.class);
        ...
        int drawable = R.drawable.letratt;
    ...
    public void onDrawFinish() {
        ...
        new Handler().postDelayed(new Runnable() {
            ...
            public void run() {
                ...
                Intent intent=new Intent(Drawable_letter_tt.this, Drawable_letter_uu.class);
                startActivity(intent);
