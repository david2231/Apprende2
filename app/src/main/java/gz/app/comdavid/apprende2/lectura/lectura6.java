...
// Clase de la actividad lectura6
public class lectura6 extends AppCompatActivity  implements View.OnClickListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        azul=(VideoView) findViewById(R.id.pedroblanco) ;
        //LLamado a la ubicadión del video en el paquete raw
        String path=("android.resource://"+getPackageName()+"/"+R.raw.pedro);
        //Obtención del video
        ...
        findViewById(R.id.pedroblanco).setOnClickListener(this);
        //Permite presionar en cualquier lugar del video para volver a reproducirlo
        bien=(TextView) findViewById(R.id.textoo6);
        //Permite presionar en cualquier lugar del video para volver a reproducirlo
        grabar = (TextView) findViewById(R.id.txtGrabarVoz6);
        //Se declara una variable local para almacenar las palabras correctas
        puntajes=(TextView) findViewById(R.id.puntajeLectura6);
        //Se declara una variable local para almacenar las palabras incorrectas
        incorrecta=(TextView) findViewById(R.id.incorrectasLectura6);
        ...
        Button inicio= (Button) findViewById(R.id.casa_lectura6);
        ...
        Button sig= (Button) findViewById(R.id.siguiente_lectura6);
        ...
        Button anterior= (Button) findViewById(R.id.anterior_lectura6);
        ...
        Button azull= (Button) findViewById(R.id.botonazul6);
        ...
        Button omitirr= (Button) findViewById(R.id.omitir6);
    ...
    public void onClickImgBtnHablar6(View v) {
