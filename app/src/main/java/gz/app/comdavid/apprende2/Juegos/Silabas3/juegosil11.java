...
public class juegosil11 extends AppCompatActivity implements View.OnClickListener  {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        puntajes=(TextView) findViewById(R.id.puntajesilabasd1);
        //Se declara una variable local para almacenar las palabras incorrectas
        incorrecta=(TextView) findViewById(R.id.incorrectassilbasd1);
        ...
        txtIdentificador=(TextView) findViewById(R.id.Categoria_D);
        //Declaración del identificador del submodulo
        txtIdentificadorSubmodulo=(TextView) findViewById(R.id.SubmoduloD);
        //Declaración del identificador del usuario
        textNickName=(TextView)findViewById(R.id.Nombre_user_JuegoD);
        //Declaración del modulo
        Modulo=(TextView)findViewById(R.id.Modulo_LecturaD);
    ...
    private void ejecutarServicios(String URL){
        StringRequest stringRequest=new StringRequest(Request.Method.POST, URL, new Response.Listener<String>() {
            ...
            public void onErrorResponse(VolleyError error) {
                Toast.makeText(juegosil11.this,error.toString(),Toast.LENGTH_SHORT).show();
