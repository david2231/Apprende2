...
//Clase Juegossilaba
public class juegosil19 extends AppCompatActivity implements View.OnClickListener  {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_juegosil19);
        //Se llama el audio
        ...
        silba=(ImageView) findViewById(R.id.siljuegofo2);
        silbas=(ImageView) findViewById(R.id.siljuegofi4);
        silbe=(ImageView) findViewById(R.id.siljuegofi5);
        err=(ImageView) findViewById(R.id.silerror19);
        //Se llaman el contenedor
        casss=(RelativeLayout) findViewById(R.id.vista19);
        //Audio Bien
        mp= MediaPlayer.create(this,R.raw.bien);
        //Audio Mal
        mp2= MediaPlayer.create(this,R.raw.mal);
        // Sonido Casa
        mp3= MediaPlayer.create(this,R.raw.foca);
        // se llaman las Imagenes
        findViewById(R.id.siljuegofo).setOnClickListener(this);
        findViewById(R.id.siljuegofo2).setOnClickListener(this);
        findViewById(R.id.siljuegofi4).setOnClickListener(this);
        findViewById(R.id.siljuegofi5).setOnClickListener(this);
        //Se declara una variable local para almacenar las palabras correctas
        puntajes=(TextView) findViewById(R.id.puntajesilabasf4);
        //Se declara una variable local para almacenar las palabras incorrectas
        incorrecta=(TextView) findViewById(R.id.incorrectassilbasf4);
        //Se actualizan los campos de correctas  e incorrectas con las variables globales de utilidades
        puntajes.setText(Integer.toString(Utilidades.correctas));
        incorrecta.setText(Integer.toString(Utilidades.incorrectas));

        // sonido de la silaba 19
        Button sonidoa = (Button)findViewById(R.id.sonidosilabas19);
        ...
        // evento botón  inicio
        Button inicio= (Button) findViewById(R.id.casa_sill19);
            ...
            case R.id.siljuegofo2:
                ...
                new Handler().postDelayed(new Runnable() {
                    ...
                    public void run() {
                        ...
                        Intent intent=new Intent(juegosil19.this,juegosil20.class);
