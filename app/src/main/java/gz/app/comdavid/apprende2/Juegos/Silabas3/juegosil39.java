...
//Clase Juegossilaba
public class juegosil39 extends AppCompatActivity implements View.OnClickListener  {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_juegosil39);
        //Se llama el audio
        ...
        silba=(ImageView) findViewById(R.id.siljuegono2);
        silbas=(ImageView) findViewById(R.id.siljuegoni4);
        silbe=(ImageView) findViewById(R.id.siljuegoni5);
        err=(ImageView) findViewById(R.id.silerror39);
        //Se llaman el contenedor
        casss=(RelativeLayout) findViewById(R.id.vista39);
        //Audio Bien
        mp= MediaPlayer.create(this,R.raw.bien);
        //Audio Mal
        mp2= MediaPlayer.create(this,R.raw.mal);
        // Sonido Casa
        mp3= MediaPlayer.create(this,R.raw.noche);
        // se llaman las Imagenes
        findViewById(R.id.siljuegono).setOnClickListener(this);
        findViewById(R.id.siljuegono2).setOnClickListener(this);
        findViewById(R.id.siljuegoni4).setOnClickListener(this);
        findViewById(R.id.siljuegoni5).setOnClickListener(this);

        //Se declara una variable local para almacenar las palabras correctas
        puntajes=(TextView) findViewById(R.id.puntajesilabasn4);
        //Se declara una variable local para almacenar las palabras incorrectas
        incorrecta=(TextView) findViewById(R.id.incorrectassilbasn4);
        //Se actualizan los campos de correctas  e incorrectas con las variables globales de utilidades
        puntajes.setText(Integer.toString(Utilidades.correctas));
        incorrecta.setText(Integer.toString(Utilidades.incorrectas));

        // sonido de la silaba 39
        Button sonidoa = (Button)findViewById(R.id.sonidosilabas39);
        ...
        // evento botón  inicio
        Button inicio= (Button) findViewById(R.id.casa_sill39);
            ...
            case R.id.siljuegono2:
                ...
                new Handler().postDelayed(new Runnable() {
                    ...
                    public void run() {
                        ...
                        Intent intent=new Intent(juegosil39.this,juegosil40.class);
