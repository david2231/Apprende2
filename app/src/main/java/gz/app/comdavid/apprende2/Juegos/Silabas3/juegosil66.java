...
public class juegosil66 extends AppCompatActivity implements View.OnClickListener  {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        puntajes=(TextView) findViewById(R.id.puntajesilabasy1);
        //Se declara una variable local para almacenar las palabras incorrectas
        incorrecta=(TextView) findViewById(R.id.incorrectassilbasy1);
        ...
        txtIdentificador=(TextView) findViewById(R.id.Categoria_Y);
        //Declaración del identificador del submodulo
        txtIdentificadorSubmodulo=(TextView) findViewById(R.id.SubmoduloY);
        //Declaración del identificador del usuario
        textNickName=(TextView)findViewById(R.id.Nombre_user_JuegoY);
        //Declaración del modulo
        Modulo=(TextView)findViewById(R.id.Modulo_LecturaY);
    ...
    private void ejecutarServicios(String URL){
        StringRequest stringRequest=new StringRequest(Request.Method.POST, URL, new Response.Listener<String>() {
            ...
            public void onErrorResponse(VolleyError error) {
                Toast.makeText(juegosil66.this,error.toString(),Toast.LENGTH_SHORT).show();
