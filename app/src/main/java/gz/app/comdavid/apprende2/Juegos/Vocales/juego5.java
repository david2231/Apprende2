...
public class juego5 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Button inicio= (Button) findViewById(R.id.casa_aa5);
        ...
        Button avatar=(Button) findViewById(R.id.sonidosilabas5);
                ...
                case DragEvent.ACTION_DRAG_ENTERED:
                    ...
                    if(view.getId()==R.id.txta6){
                        ...
                        if (view.getId() == R.id.txtjb6) {
                            //Se suma un punto a la opción correctas
                            ...
                            new Handler().postDelayed(new Runnable() {
                                ...
                                public void run() {
                                    //Abrir una nueva actividad
                                    Intent intent=new Intent(juego5.this,juego6.class);
