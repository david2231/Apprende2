...
public class ResultadoJuegoSilabasf extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_resultado_juego_silabasf);
        //Se mantiene la pantalla activa
        getWindow().addFlags(WindowManager.LayoutParams.FLAG_KEEP_SCREEN_ON);
        //Llamado a la texto resultado
        txtResultados =findViewById(R.id.txtResultadosSilabaf);
        //Llamado al campo variables correctas
        txtCorrectas =findViewById(R.id.txtResPalabrasCorrectasJuegoSilabaf);
        //Llamado al campo variables incorrectas
        txtIncorrectas=findViewById(R.id.txtPalabrasIncorrectasSilabaf);
        //Llamado al texto Incorrectas
        txtResCorrectas =findViewById(R.id.txtResPalabrasCorrectasSilabaf);
        //Llamado al campo variables incorrectas
        txtResIncorrectas=findViewById(R.id.txtResPalabrasIncorrectasSilabaf);
        //Permite almacenar el id del avatar
        txtPuntaje =findViewById(R.id.txtPuntajeTituloSilabaf);
        //Permite almacenar el nombre del usuario
        textNickName=findViewById(R.id.textNickNameSilabaf);
        //llama la Imagen del usuario
        imagenAvatar=findViewById(R.id.avatarImageSilabaf);
        ...
        txtIdentificadorJuego=(TextView) findViewById(R.id.IdentificadorJuegosf);
        ...
        btnInicio=findViewById(R.id.inicioJuegoSilabaf);
    ...
    private void ejecutarServcios(String URL){
        StringRequest stringRequest=new StringRequest(Request.Method.POST, URL, new Response.Listener<String>() {
            ...
            public void onErrorResponse(VolleyError error) {
                ...
                Toast.makeText(ResultadoJuegoSilabasf.this,error.toString(),Toast.LENGTH_SHORT).show();
            }
        }){
