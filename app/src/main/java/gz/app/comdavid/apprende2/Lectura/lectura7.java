...
// Clase de la actividad lectura7
public class lectura7 extends AppCompatActivity  implements View.OnClickListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_lectura7);
        //Se mantiene la pantalla activa
        getWindow().addFlags(WindowManager.LayoutParams.FLAG_KEEP_SCREEN_ON);
        //Llamado del videoview
        azul=(VideoView) findViewById(R.id.elpeznaranja) ;
        //LLamado a la ubicadión del video en el paquete raw
        String path=("android.resource://"+getPackageName()+"/"+R.raw.pescado);
        //Obtención del video
        ...
        findViewById(R.id.elpeznaranja).setOnClickListener(this);
        //Permite presionar en cualquier lugar del video para volver a reproducirlo
        bien=(TextView) findViewById(R.id.textoo7);
        //Permite presionar en cualquier lugar del video para volver a reproducirlo
        grabar = (TextView) findViewById(R.id.txtGrabarVoz7);
        //Se declara una variable local para almacenar las palabras correctas
        puntajes=(TextView) findViewById(R.id.puntajeLectura7);
        //Se declara una variable local para almacenar las palabras incorrectas
        incorrecta=(TextView) findViewById(R.id.incorrectasLectura7);
        ...
        Button inicio= (Button) findViewById(R.id.casa_lectura7);
        ...
        Button sig= (Button) findViewById(R.id.siguiente_lectura7);
        ...
        Button anterior= (Button) findViewById(R.id.anterior_lectura7);
        ...
        Button azull= (Button) findViewById(R.id.botonazul7);
        ...
        Button omitirr= (Button) findViewById(R.id.omitir7);
    ...
    public void onClickImgBtnHablar7(View v) {
