...
public class ResultadoJuegoSilabasc extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_resultado_juego_silabasc);
        //Se mantiene la pantalla activa
        getWindow().addFlags(WindowManager.LayoutParams.FLAG_KEEP_SCREEN_ON);
        //Llamado a la texto resultado
        txtResultados =findViewById(R.id.txtResultadosSilabac);
        //Llamado al campo variables correctas
        txtCorrectas =findViewById(R.id.txtResPalabrasCorrectasJuegoSilabac);
        //Llamado al campo variables incorrectas
        txtIncorrectas=findViewById(R.id.txtPalabrasIncorrectasSilabac);
        //Llamado al texto Incorrectas
        txtResCorrectas =findViewById(R.id.txtResPalabrasCorrectasSilabac);
        //Llamado al campo variables incorrectas
        txtResIncorrectas=findViewById(R.id.txtResPalabrasIncorrectasSilabac);
        //Permite almacenar el id del avatar
        txtPuntaje =findViewById(R.id.txtPuntajeTituloSilabac);
        //Permite almacenar el nombre del usuario
        textNickName=findViewById(R.id.textNickNameSilabac);
        //llama la Imagen del usuario
        imagenAvatar=findViewById(R.id.avatarImageSilabac);
        ...
        txtIdentificadorJuego=(TextView) findViewById(R.id.IdentificadorJuegosc);
        ...
        btnInicio=findViewById(R.id.inicioJuegoSilabac);
    ...
    private void ejecutarServcios(String URL){
        StringRequest stringRequest=new StringRequest(Request.Method.POST, URL, new Response.Listener<String>() {
            ...
            public void onErrorResponse(VolleyError error) {
                ...
                Toast.makeText(ResultadoJuegoSilabasc.this,error.toString(),Toast.LENGTH_SHORT).show();
            }
        }){
