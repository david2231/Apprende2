...
public class Drawable_letter_ss extends AppCompatActivity implements Main_drawable.DrawFinishListener {
    MediaPlayer mp,mp2;
    Button button;
    ...
    protected void onCreate(Bundle savedInstanceState) {
            ...
            public void onClick(View v) {
                ...
                new Handler().postDelayed(new Runnable() {
                    ...
                    public void run() {
                        ...
                        Intent intent=new Intent(Drawable_letter_ss.this, Drawable_letter_ss.class);
        ...
        int drawable = R.drawable.letrass;
    ...
    public void onDrawFinish() {
        ...
        new Handler().postDelayed(new Runnable() {
            ...
            public void run() {
                ...
                Intent intent=new Intent(Drawable_letter_ss.this, Drawable_letter_tt.class);
                startActivity(intent);
