...
public class juegosil35 extends AppCompatActivity implements View.OnClickListener  {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        puntajes=(TextView) findViewById(R.id.puntajesilabasm5);
        //Se declara una variable local para almacenar las palabras incorrectas
        incorrecta=(TextView) findViewById(R.id.incorrectassilbasm5);
            ...
            case R.id.siljuegomo4:
                ...
                new Handler().postDelayed(new Runnable() {
                    ...
                    public void run() {
                        ...
                        Intent intent=new Intent(juegosil35.this, ResultadoJuegoSilabasm.class);
