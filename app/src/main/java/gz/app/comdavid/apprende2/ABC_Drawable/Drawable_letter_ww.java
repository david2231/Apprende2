...
public class Drawable_letter_ww extends AppCompatActivity implements Main_drawable.DrawFinishListener {
    MediaPlayer mp,mp2;
    Button button;
    ...
    protected void onCreate(Bundle savedInstanceState) {
            ...
            public void onClick(View v) {
                ...
                new Handler().postDelayed(new Runnable() {
                    ...
                    public void run() {
                        ...
                        Intent intent=new Intent(Drawable_letter_ww.this, Drawable_letter_ww.class);
        ...
        int drawable = R.drawable.letraww;
    ...
    public void onDrawFinish() {
        ...
        new Handler().postDelayed(new Runnable() {
            ...
            public void run() {
                ...
                Intent intent=new Intent(Drawable_letter_ww.this, Drawable_letter_xx.class);
                startActivity(intent);
