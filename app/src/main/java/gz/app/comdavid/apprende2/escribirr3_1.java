...
public class escribirr3_1 extends AppCompatActivity implements escribirr3.DrawFinishListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_escribirr3_1);
        ...
        button = (Button)findViewById(R.id.botonreset1);
            ...
            public void onClick(View v) {
                ...
                new Handler().postDelayed(new Runnable() {
                    ...
                    public void run() {
                        ...
                        Intent intent=new Intent(escribirr3_1.this,escribirr3_1.class);
    ...
    public void onDrawFinish() {
        ...
        new Handler().postDelayed(new Runnable() {
            ...
            public void run() {
                ...
                Intent intent=new Intent(escribirr3_1.this,escribir4_1.class);
                startActivity(intent);
                finish();
